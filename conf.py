beijing_label_hparams = {
    ...
    "adj" : "/data/wuning/NTLR/beijing/CompleteAllGraph",
    "t_adj" : "/data/wuning/RN-GNN/beijing/loc_tra_adj",
    "node_features" : "/data/wuning/RN-GNN/beijing/node_features",
    "label_train_set": "/data/wuning/RN-GNN/beijing/label_pred_train_set",
    "label_train_set_false": "/data/wuning/RN-GNN/beijing/label_pred_train_set_false",
...
beijing_route_hparams = {
    ...
    "fnc_cmt_dims" : 256,
    "train_cmt_set" : "/data/wuning/RN-GNN/beijing/train_cmt_set",
    "train_loc_set" : "/data/wuning/NTLR/beijing/train_loc_5_set",
    "train_time_set" : "/data/wuning/NTLR/beijing/train_time_set_eta",
    "adj" : "/data/wuning/NTLR/beijing/CompleteAllGraph",
    "t_adj" : "/data/wuning/RN-GNN/beijing/loc_tra_adj",
    "node_features" : "/data/wuning/RN-GNN/beijing/node_features",
...
beijing_hparams = {
    ...
    "fnc_cmt_dims" : 256,
    "train_cmt_set" : "/data/wuning/RN-GNN/beijing/train_cmt_set",
    "train_loc_set" : "/data/wuning/NTLR/beijing/train_loc_10_set",
    "train_time_set" : "/data/wuning/NTLR/beijing/train_time_set_eta",
    "adj" : "/data/wuning/NTLR/beijing/CompleteAllGraph",
    "t_adj" : "/data/wuning/RN-GNN/beijing/loc_tra_adj",
    "node_features" : "/data/wuning/RN-GNN/beijing/node_features",
